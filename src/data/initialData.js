...
export const initialProducts = [
  ...
  { id: 4,  name: 'Papas McCain 700g',        desc: 'Crinkle cut',            price: 890,  emoji: '🍟', cat: 'mccain',       showPrice: true,  active: true },
  { id: 5,  name: 'Aros de Cebolla McCain',   desc: 'Crujientes y dorados',   price: 750,  emoji: '🧅', cat: 'mccain',       showPrice: true,  active: true },
  ...
  { id: 8,  name: 'Alfajor Oreo x12',         desc: 'Con relleno doble',      price: 2200, emoji: '🍪', cat: 'alfajores',    showPrice: true,  active: true },
